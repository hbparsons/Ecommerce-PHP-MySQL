...
<body>
  ...
  <form id="create-account-form" action="create-account-action.php" method="POST">
          ...
          <div class="card-text">
            ...
            <div class="d-flex flex-wrap justify-content-left">
              ...
              <div class="me-5 mb-3">
                ...
                <input type="text" name="firstname" class="form-control" id="firstname" value="<?php if (isset($_POST['firstname'])) echo $_POST['firstname']; ?>" required>
              </div>
              <div class="mb-3">
                <label for="lastname" class="form-label">Last Name</label>
                <input type="text" name="lastname" class="form-control" id="lastname" value="<?php if (isset($_POST['lastname'])) echo $_POST['lastname']; ?>" required>
              </div>
            </div>
            <div class="mb-3">
            ...
            <div class="d-flex flex-wrap justify-content-end my-3">
              <button type="submit" class="btn btn-primary mt-3" id="submit-btn">Create Account</button>
            </div>
          </div>
  ...
  <script>
    ...
    const validate = (e) => {
      ...
      if (firstname.value === "" || !nameIsValid(firstname.value)) {
      ...
      if (lastname.value === "" || !nameIsValid(lastname.value)) {
    ...
    // Added the nameIsValid function to validate that firstname and lastname contain only alphabetic characters.
    const nameIsValid = name => /^[a-zA-Z]+$/.test(name);
